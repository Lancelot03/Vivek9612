...
export default function WorkingHomePage() {
  ...
  const handleLogin = () => {
    ...
    try {
      router.push({
        pathname: '/auth/login',
        params: { employeeCode, password }
      });
    } catch (error) {
      console.error('Navigation error:', error);
      Alert.alert('Navigation Error', 'Unable to navigate to login. Please try again.');
    }
  };
        ...
        <View style={styles.loginSection}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              Alert.alert(
                'Quick Access',
                'For existing users without accounts. Use your Employee ID to access RSVP.',
                [
          ...
          >
            <Text style={styles.secondaryButtonText}>⚡ Legacy Access</Text>
          </TouchableOpacity>
        </View>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              try {
                ...
                Alert.alert('Navigation Test', 'Router is working! ✅');
              }
            }}
          >
